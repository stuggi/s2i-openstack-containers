...
// Package users provides a central registry of OpenStack service UIDs/GIDs.
// Go operators import the constants directly (e.g. users.KeystoneUID);
// container image builds use the generated zz_generated_uid_gid.yaml
// (regenerate with: make generate-service-uids).
// The uid_gid_manage script in containers/base/scripts/ reads the same YAML
// at image build time to create the system users.
package users
...
var Registry = map[string]ServiceUser{
	"ansible":          {UID: AnsibleUID, GID: AnsibleGID, Home: "/var/lib/ansible"},
	"aodh":             {UID: AodhUID, GID: AodhGID, Home: "/var/lib/aodh"},
	"barbican":         {UID: BarbicanUID, GID: BarbicanGID, Home: "/var/lib/barbican", Groups: []string{"nfast"}},
	...
	"memcached":        {UID: MemcachedUID, GID: MemcachedGID, Home: "/run/memcache"},
	...
	"nova":             {UID: NovaUID, GID: NovaGID, Home: "/var/lib/nova", Groups: []string{"libvirt", "qemu", "tss"}},
	"octavia":          {UID: OctaviaUID, GID: OctaviaGID, Home: "/var/lib/octavia"},
	"openvswitch":      {UID: OpenvswitchUID, GID: OpenvswitchGID},
	"ovn-bgp":          {UID: OvnBgpUID, GID: OvnBgpGID, Home: "/var/lib/ovn-bgp"},
	...
	"rally":            {UID: RallyUID, GID: RallyGID, Home: "/var/lib/rally"},
	"redis":            {UID: RedisUID, GID: RedisGID, Home: "/run/redis"},
	"swift":            {UID: SwiftUID, GID: SwiftGID, Home: "/var/lib/swift"},
	"tempest":          {UID: TempestUID, GID: TempestGID, Home: "/var/lib/tempest"},
	"tobiko":           {UID: TobikoUID, GID: TobikoGID, Home: "/var/lib/tobiko"},
	"tss":              {UID: TssUID, GID: TssGID},
	"valkey":           {UID: ValkeyUID, GID: ValkeyGID, Home: "/run/valkey"},
